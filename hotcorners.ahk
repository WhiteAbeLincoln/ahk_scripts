...
; ScreenArray[ScreenIndex][CordDirection]
; ScreenIndex (For 3 monitors): 1, 2, 3
; CordDirection:
; Left : 1
; Right : 3
; Top : 2
...
; tolerance value
; TopLeft - tolerance applies in X+ and Y+
; TopRight - tolerance applies in X- and Y+
; BottomLeft - tolerance applies in X+ and Y-
; BottomRight - tolerance applies in X- and Y-
